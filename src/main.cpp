...
// Delay in seconds Set to 100ms
constexpr double delay_seconds = 0.1;
...
int main() {
  ...
  h.onMessage(
      [&mpc, &delay_ms](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
          uWS::OpCode opCode) {
        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
          ...
          if (s != "") {
            ...
            if (event == "telemetry") {
              ...
              /*
               * Transform the points returned by simulator.
               * The points from simulator are in map system, transform them to vehicle's system.
               */
